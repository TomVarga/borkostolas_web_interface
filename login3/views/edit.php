...
<form method="post" action="editProfile.php" name="user_edit_form_name">
...
<form method="post" action="editProfile.php" name="user_edit_form_email">
...
<form method="post" action="editProfile.php" name="user_edit_form_password">
