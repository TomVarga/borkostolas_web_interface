...
define("MESSAGE_LOGIN_FAILED", "Sikertelen bejelentkezés");
...
define("WORDING_NEW_PASSWORD_REPEAT", "Ismételten jelszó");
define("WORDING_NEW_USERNAME", "Új felhasználónév (felhasználónév nem lehet üres és betűket és számokat tartalmazhat, 2-64 karakternek hossz között kell lennie)");
...
define("WORDING_REGISTER_NEW_ACCOUNT", "Regisztráció");
...
define("WORDING_REGISTRATION_PASSWORD_REPEAT", "Ismételten jelszó");
