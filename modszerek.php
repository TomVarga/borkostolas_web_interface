...
<div id="wrapper">
	...
	<div id="contentWrapper">
		...
		<div id="content">
			...
			<p>
				Részletes leírás <a href="https://github.com/TomVarga/borkostolas_szakdolgozat/blob/master/VargaTamas.pdf" class="link">ebben</a> a szakdolgozatban található, melynek feladata volt a web és mobil
				alkalmazás elkészítése.<br/>
			</p>
		</div>
	</div>
